...
import ccv.checkhelzio.nuevaagendacucsh.transitions.CircularReveal;
import ccv.checkhelzio.nuevaagendacucsh.util.TransitionUtils;
...
public class SearchActivity extends Activity {
    ...
    private void setupSearchView() {
        ...
        searchView.setQueryHint("Busca un evento por titulo:");
